...
use SkypeSDK\DataProvider\OpenIdConfigProvider;
use SkypeSDK\DataProvider\OpenIdKeysProvider;
use SkypeSDK\DataProvider\TokenProvider;
use SkypeSDK\Interfaces\DataStorage;
use SkypeSDK\Listener\Dispatcher;
use SkypeSDK\Listener\Request;
use SkypeSDK\Listener\Security;
...
class SkypeSDK
{
    ...
    protected function initComponents(Config $config, DataStorage $dataStorage)
    {
        ...
        $this->set('security', function() {
            return new Security(SkypeSDK::getInstance()->getOpenIdKeysProvider());
        });
        $this->set('dispatcher', function() {
            return new Dispatcher(SkypeSDK::getInstance()->getSecurity());
        });
    ...
    {
        static::$instance = new SkypeSDK($config, $dataStorage);
    ...
    public static function getInstance()
    {
        if (static::$instance === null) {
            throw new \Exception('SkypeSDK not initialized.');
        }
        return static::$instance;
    }
