...
use SkypeSDK\Interfaces\ContactUpdateHandler;
use SkypeSDK\Interfaces\ConversationUpdateHandler;
use SkypeSDK\Interfaces\MessageHandler;
...
class Dispatcher
{
    ...
    {
        $request = SkypeSDK::getInstance()->getRequest();
